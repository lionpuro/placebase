<script lang="ts">
	...
	const config = {
		variants: {
			primary: "bg-primary-600/90 hover:bg-primary-600 text-base-white",
			secondary: "bg-base-100/90 hover:bg-base-200/70 text-base-800",
			outline: "hover:bg-base-50 outline outline-base-100",
			black: "bg-base-950 hover:bg-base-950/95 text-base-white",
		},
		sizes: {
