export { default as IconMenu } from "virtual:icons/mdi/menu";
export { default as IconClose } from "virtual:icons/mdi/close";
export { default as IconCopy } from "virtual:icons/mdi/content-copy";
